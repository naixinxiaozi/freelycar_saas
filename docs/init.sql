...
INSERT INTO `freelycar_saas`.`sysuser`(`id`, `createTime`, `delStatus`, `password`, `permissions`, `phone`, `remark`, `staffName`, `storeId`, `username`) VALUES (1, CURRENT_TIMESTAMP, b'0', '48a365b4ce1e322a55ae9017f3daf0c0', NULL, NULL, '初始化生成', '超级管理员', NULL, 'sysadmin');
INSERT INTO `freelycar_saas`.`sysuser`(`id`, `createTime`, `delStatus`, `password`, `permissions`, `phone`, `remark`, `staffName`, `storeId`, `username`) VALUES (2, CURRENT_TIMESTAMP, b'0', '21232f297a57a5a743894a0e4a801fc3', NULL, NULL, '初始化生成', '测试管理员', '1', 'admin');
